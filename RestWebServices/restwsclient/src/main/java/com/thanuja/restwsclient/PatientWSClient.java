package com.thanuja.restwsclient;
...
import com.thanuja.restwsclient.model.Patient;
...
public class PatientWSClient {
	...
	public static void main(String[] args) {
		...
		patient.setName("ThanujaKallamadi");
		...
		Patient createdPatient = postTarget.request().post(Entity.entity(patient,MediaType.APPLICATION_XML),Patient.class);
